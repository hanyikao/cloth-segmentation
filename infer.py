...
def get_legend():
    class_to_color = dict()
    class_name = ['background', 'tops', 'sweaters', 'outerwear', 'bottoms', 'wholebody']
...
if __name__ == "__main__":
    ...
    # image_dir = "../tops" #
    image_dir = "../imaterialist/taelor"
    result_dir = "results/training_cloth_segm_u2net_exp5/images"
    ...
    for idx, image_name in enumerate(images_list):
        ...
        output = output.resize((h, w), Image.BILINEAR)
        if do_palette:
